/**
 * ═══════════════════════════════════════════════════════════════════════════════
 * DEPRECATED - Questions now stored in Supabase - DO NOT EDIT THIS FILE
 * ═══════════════════════════════════════════════════════════════════════════════
 *
 * This file is kept as an EMERGENCY BACKUP only.
 *
 * All questions are now stored in the Supabase 'questions' table.
 * The server reads from Supabase on startup and caches questions in memory.
 * Admin panel operations (add, edit, delete) go directly to Supabase.
 *
 * To migrate questions to Supabase:
 * 1. Run the SQL in server/supabase-questions-table.sql in Supabase Dashboard
 * 2. Run: node server/migrate-questions.js
 *
 * This file will ONLY be used as fallback if Supabase is unavailable.
 * ═══════════════════════════════════════════════════════════════════════════════
 */
